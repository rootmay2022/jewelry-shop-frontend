...
import { ShoppingCartOutlined, HomeOutlined, SafetyCertificateOutlined, CarOutlined, ThunderboltOutlined } from '@ant-design/icons';
...
const ProductDetailPage = () => {
    ...
    const handleBuyNow = () => {
        ...
        // Chuyển hướng đến trang checkout và gửi kèm thông tin sản phẩm này
        navigate('/checkout', { 
            state: { 
                buyNow: true, 
                product: product, 
                    ...
                    <Col xs={24} md={12}>
                        <Space direction="vertical" size={24} style={{ width: '100%' }}>
                            ...
                            <div style={{ marginTop: '20px' }}>
                                <Text type="secondary" style={{ fontSize: '11px', display: 'block', marginBottom: '8px' }}>SỐ LƯỢNG MUA</Text>
                                <Space align="start" size={16} style={{ width: '100%' }}>
                                    <InputNumber 
                                        ...
                                        style={{ width: '80px', height: '50px', display: 'flex', alignItems: 'center' }}
                                    />
                            ...
                            <div style={{ background: theme.gray, padding: '20px', borderRadius: '8px', marginTop: '20px' }}>
                                <Space direction="vertical">
                                    <Space><SafetyCertificateOutlined style={{ color: theme.gold }} /> <Text size="small">Cam kết hàng chính hãng 100%</Text></Space>
