...
const Login = () => {
  ...
  return (
    <div style={{ 
      ...
      minHeight: '100vh',
      padding: '20px',
      background: `linear-gradient(rgba(0, 21, 41, 0.7), rgba(0, 21, 41, 0.7)), url('https://images.unsplash.com/photo-1550684848-fac1c5b4e853?auto=format&fit=crop&q=80&w=2070')`,
